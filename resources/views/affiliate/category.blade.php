        ...
        <div class="col-xl-3 col-lg-4 col-md-5">
                <div class="sidebar-categories" >
                        ...
                        <ul class="list-group" id="subcategories" >
                            ...
                            <a   href="/subcategories/{{ $subcategory->subcategory_slug }}"><li class="category-link list-group-item" style="font-size:12px;color:black">{{ ucwords($subcategory->subcategory_name) }}</li></a>
                               @endforeach
                      ...
                      <style>
                        ...
                        <div class="sidebar-categories" >
                          ...
                          <ul class="list-group" id="maincategories">
                              ...
                              <a style="color:black"   href="/products/{{ $category->category_slug }}"><li class="category-link list-group-item" style="font-size:12px">{{ ucwords($category->category_name) }} ({{  $categoryCount[$index] }})</li></a>
                              @php
                                  $index=$index+1;
                              @endphp
                              @endforeach
